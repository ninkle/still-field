...
assert(emitted.length>=4&&emitted.length<=8,'Stationary people must periodically emit without flooding the field');
...
console.log('Person tracking, standing pulses, alternating footstep cadence at 15/30/60 fps, jitter suppression, pause and cleanup passed.');
